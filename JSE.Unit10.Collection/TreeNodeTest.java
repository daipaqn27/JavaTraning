...
public class TreeNodeTest {
    public static void main(String[] args) {
        ...
        System.out.println("next sibling of " + node1.getValue() 
                + " is " + node2.getValue());
        
        TreeNode<String> node3 = node2.getNextSibling();
        System.out.println("next sibling of " + node2.getValue() 
                + " is " + node3.getValue());        
        ...
        System.out.println("check contains 2.1.1 = " 
                +TreeNodeUtils.contains(root, "2.1.1"));
